...
class _AddTransactionScreenState extends ConsumerState<AddTransactionScreen> {
  ...
  PujaTransactionType _type = PujaTransactionType.collection;
  String? _category;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text(PujaStrings.addTransaction)),
      body: isAdmin
